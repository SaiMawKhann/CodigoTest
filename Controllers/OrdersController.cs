...
namespace CodigoTest.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        public OrdersController(CodigoTestDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Order>> GetOrderDetails(int id)
        {
            var order = _context.Orders
                                            .Include(pub => pub.OrderItems)
                                            .Where(pub => pub.OrderId == id)
                                            .FirstOrDefault();
        ...
        public async Task<ActionResult<Order>> PostOrder(Order order)
        {
          if (_context.Orders == null)
          {
              return Problem("Entity set 'CodigoTestDatabaseContext.Orders'  is null.");
          }
